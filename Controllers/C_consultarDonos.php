...
if ($resultado->num_rows > 0) { ?>
  ...
  <body>
    ...
    echo "</table><br><br><br><a href='../index.php'>Voltar Para o Menu Principal</a></body></html>";
  } else {
    echo "<script> alert('Nenhum dono encontrado!');document.location='../index.php'</script>";
  }
