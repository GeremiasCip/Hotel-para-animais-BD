...
class AnimalDAO {
    ...
    function SalvarAnimal($animal, $connect) {
        $sql = "INSERT INTO Animal(nomeAnimal, anoNascimento, observacoes, especie, raca) VALUES ('" .
    ...
    function ConsultarTodosAnimaisCPF($connect, $CPF) {
        $sql = "SELECT * FROM Animal WHERE CPF=".$CPF;
        $resultado = $connect->query($sql);
        return $resultado;
    }
